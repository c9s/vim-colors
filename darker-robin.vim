...
hi CursorLine       guibg=#112222
hi Directory		guifg=#ccccff	gui=none
" hi DiffAdd
" hi DiffChange
" hi DiffDelete
" hi DiffText
hi ErrorMsg			guifg=White 	guibg=Red		gui=none
hi Folded           guifg=White     guibg=#807057
"hi FoldColumn
" hi IncSearch
hi ModeMsg          guifg=Black     guibg=yellowgreen gui=none
hi MoreMsg          guifg=#d05a50
...
hi Function			guifg=#ccff33				    gui=none

hi Statement		guifg=#b35554					gui=none
hi Conditional		guifg=#b05a50					gui=none
hi Repeat			guifg=#b05a50					gui=none
hi Label			guifg=#b05a50					gui=none
hi Operator			guifg=#c0caa8					gui=none
hi Keyword			guifg=#d05a50					gui=none
hi Exception		guifg=#d05a50					gui=none
...
hi Todo				guifg=#900000	guibg=#f0f000	gui=none

"hi perlStatementMisc	ctermfg=yellow	ctermbg=none	cterm=bold
hi perlTodo		    guifg=Black	    guibg=yellow	gui=none
