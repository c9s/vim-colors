...
hi Folded	ctermfg=White	ctermbg=DarkBlue	cterm=bold
...
hi perlStatementList	ctermfg=darkyellow	ctermbg=none	cterm=none
"
"" keyword:		warn formline reset scalar delete prototype lock
hi perlStatementMisc	ctermfg=red	ctermbg=none	cterm=bold
"
