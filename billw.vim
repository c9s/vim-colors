...
" Version: 0.1
"
" Improved by Cornelius <cornelius.howl@gmail.com>
...
hi Directory            guifg=orange1 guibg=NONE
"hi DiffAdd
"hi DiffChange
"hi DiffDelete
"hi DiffText
hi ErrorMsg             gui=bold guifg=White guibg=Red
hi VertSplit            guifg=black guibg=orange1
hi Folded               guibg=black guifg=orange1
hi FoldColumn           guibg=black guifg=orange1
hi IncSearch            gui=REVERSE
"hi LineNr
hi ModeMsg              gui=bold guifg=black guibg=orange2 
hi MoreMsg              gui=bold guifg=black guibg=orange2 
"hi NonText
...
hi Comment              guifg=#aaaa00 guibg=#131313
